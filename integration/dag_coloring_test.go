...
// go test -v -count=1 -tags "dagcoloring" github.com/soterium/soterd/integration

package integration

import (
	"github.com/soterium/soterd/chaincfg"
	"github.com/soterium/soterd/integration/rpctest"
	"testing"
)
